...
| 3.5 | Living Context | New | ✅ Done (Phase 1–3, 6 shipped; Phase 4–5 deferred) | [→](opportunities/context/05-living-context.md) |
...
| 5.6 | Scheduled Tasks & Templates | New | 🔨 In progress (data+UI done, execution blocked: tool permissions, no scheduler helper) | [→](opportunities/context/02-task-templates-workflows.md) |
...
| U3 | Multi-Window Session Isolation | Bug | ✅ Done | [→](opportunities/architecture/10-multi-window-isolation.md) |
